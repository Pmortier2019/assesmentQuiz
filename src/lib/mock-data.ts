...
export const TESTIMONIALS = [
  {
    id: "t1",
    name: "Sophie K.",
    role: "Analyst trainee @ Deloitte",
    avatar: "SK",
    text: "I went from 55% to 84% on numerical reasoning in two weeks. The daily practice really works.",
    rating: 5,
  },
  {
    id: "t2",
    ...
    avatar: "TB",
    text: "The situational judgement tests are exactly like what Shell used. I felt so prepared on assessment day.",
    rating: 5,
  },
  {
    id: "t3",
    name: "Nina V.",
    role: "Junior consultant @ McKinsey",
    avatar: "NV",
    text: "€4/month for unlimited AI-generated tests is a no-brainer. Best investment in my job search.",
    rating: 5,
  },
  {
    id: "t4",
    ...
    avatar: "ML",
    text: "The feedback after each test showed me exactly where I was losing points. Game changer.",
    rating: 5,
  },
];

export const STATS = [
  { value: "12,400+", label: "Tests completed" },
  { value: "94%", label: "Report better scores" },
  { value: "4.8/5", label: "Average rating" },
  { value: "38", label: "AI-generated tests" },
];
